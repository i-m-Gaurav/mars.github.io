...
/**
 * * This is an overengineered coded funtion. Well, it is a complete seperate section for enlarge images.
 */
...
/** 
 * * Little close button close the enlarged image.
 */
...
/**
 * * Extract the image url from meta data, so i could play around with it.
 */
...
/**
 * * These three funtions underneath this comment are the date limits of each rovers. But this code is useless, it does nothing.
 */
...
/**
 * * I think you got it, it will hide camera buttons.
 */
...
/**
 * * As the funtion name explains it self, it will go through the  meta data and look for all the availble camera angles for particular selection.
 */
...
/**
 * * Of course it will return the current date.
 */
...
/**
 * ! This is a forbidden function, actually it never used.
 */
...
/**
 * * For the tiny red button appears when you go too down after photos of mars, it will take you to the top of page.
 */
...
/**
 * * It will make the date choosing section visible, fires when image rovers are clicked.
 */
...
/**
 * * Fires when hamburger button get activated, it opens the sidebar for mobile view.
 */
...
/**
 * * Reset the select box to its defult
 */
...
/**
 * ! validate the date, if not selected correctly, throws an alert.
 */
...
/**
 * * It will calculate the height according to the screen viewport.
 */
